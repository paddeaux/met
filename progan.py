...
PROGRESSIVE_EPOCHS = [10,10,10,10,10,10,10] #[1] * len(BATCH_SIZES) 
FIXED_NOISE = torch.randn(8,Z_DIM,1,1).to(DEVICE)
# NUM_WORKERS = 4
NUM_WORKERS = 2
GENERATE_EXAMPLES_AT = [1,4,8,12,16,20,24,28,32,36,40,44,48,52,56,60,64,68,72,76,80,84,88,92,96,100]
